...
const { DEFAULT_LENGTH, MIN_LENGTH, MAX_LENGTH } = require('./defaultConfig');

const generateShortId = (length = DEFAULT_LENGTH, withSymbols = true) => {
    ...
    const alphabet = generateAlphabet(withSymbols);
